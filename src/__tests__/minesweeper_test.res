...
let initialState = makeState([[o, o, o, o, o], [o, o, x, o, o], [o, o, o, o, o], [o, o, o, o, x]])

let initialLostState = makeState([
  [s, o, o, o, o],
  [o, o, x, s, o],
  [o, o, s, s, o],
  [o, o, o, o, m],
...
describe("Minesweeper.update", () => {
  ...
  describe("Reveal action", () => {
    ...
    test("reveals the un-Marked neighbouring fields if field already Revealed", () => {
      let initialState = makeState([
        [o, o, o, o, o],
        [o, o, fx, o, o],
        [o, o, o, s, o],
    ...
    test("creates a new arrangement of fields if first revealed field would be a mine", () => {
      let initialState = makeState([
        [x, x, x, x, x],
        [x, x, x, x, x],
        [x, o, x, x, x],
